...
module ControlUnit (
    ...
    logic [6:0] signals;
    assign {regFileWe, aluSrcMuxSel, dataWe, RFWDSrcMuxSel, branch, LUISrcMuxsel} = signals;

    always_comb begin
        signals = 7'b0;
        case (opcode)
            // {regFileWe, aluSrcMuxSel, dataWe, RFWDSrcMuxSel, branch, LUISrcMuxsel} = signals
            ...
            `OP_TYPE_LU: signals = 7'b1_0_0_00_0_1;
            `OP_TYPE_AU: signals = 7'b1_0_0_10_0_1;
        endcase
    end
