...
class transaction;
    ...
    constraint oper_ctrl { oper dist {1 :/ 80, 0:/ 20};} // 1의 값을 80%, 0의 값을 20%
...
class scoreboard;
    ...
    event gen_next_event;
    transaction fifo_tr;
    logic [7:0] scb_fifo[$]; // queue 생성 : [$] $만 넣으면 무한대로 넣기 가능
    logic [7:0] pop_data;
