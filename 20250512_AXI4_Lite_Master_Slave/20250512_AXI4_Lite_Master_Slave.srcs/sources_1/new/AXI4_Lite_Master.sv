...
//                 AWADDR  = addr;
//                 AWVALID = 1'b1;
//                 if (AWVALID && AWREADY) begin  // condition : handshaking
//                     aw_next = AW_IDLE_S;
//                 end
//             end
//         endcase
...
//                 WDATA  = wdata;
//                 WVALID = 1'b1;
//                 if (WVALID && WREADY) begin  // condition : handshaking
//                     w_next = W_IDLE_S;
//                 end
//             end
//         endcase
...
//             AR_VALID_S: begin
//                 ARVALID = 1'b1;
//                 if (ARVALID) begin  // condition : handshaking
//                     ar_next = AR_IDLE_S;
//                 end
//             end
//         endcase
